...
```html
<vds-checkbox label="Accept terms and conditions"></vds-checkbox>
```
...
```html
<vds-checkbox checked label="Remember me"></vds-checkbox>
```
...
```html
<vds-checkbox disabled label="Disabled checkbox"></vds-checkbox>
...
```html
<vds-checkbox size="regular" label="Regular size"></vds-checkbox>
<vds-checkbox size="small" label="Small size"></vds-checkbox>
```
...
<vds-checkbox 
  label="Custom styled"
  style="--vds-checkbox-bg-checked: #ff6b6b; --vds-checkbox-size: 16px;">
</vds-checkbox>
```
